...
struct AcmeVolumeAlsaPrivate
{
	...
	int (*snd_mixer_selem_get_xxx_volume_range)(
		snd_mixer_elem_t *,long *,long *);
	int (*snd_mixer_selem_get_xxx_switch)(
		snd_mixer_elem_t *, snd_mixer_selem_channel_id_t, int *);
	int (*snd_mixer_selem_get_xxx_volume)(
		snd_mixer_elem_t *, snd_mixer_selem_channel_id_t, long *);
	int (*snd_mixer_selem_set_xxx_switch_all)(
		snd_mixer_elem_t *, int);
	int (*snd_mixer_selem_set_xxx_volume_all)(
		snd_mixer_elem_t *, long );
...
acme_volume_alsa_new(gint type)
{
	...
	if (type == _CAPTURE)
	{
		obj->_priv->snd_mixer_selem_get_xxx_volume_range =
			snd_mixer_selem_get_capture_volume_range;
		obj->_priv->snd_mixer_selem_get_xxx_switch =
			snd_mixer_selem_get_capture_switch;
		obj->_priv->snd_mixer_selem_get_xxx_volume =
			snd_mixer_selem_get_capture_volume;
		obj->_priv->snd_mixer_selem_set_xxx_switch_all =
			snd_mixer_selem_set_capture_switch_all;
		obj->_priv->snd_mixer_selem_set_xxx_volume_all =
			snd_mixer_selem_set_capture_volume_all;
		obj->_priv->snd_mixer_selem_has_xxx_switch =
			snd_mixer_selem_has_capture_switch;
		obj->_priv->snd_mixer_selem_has_xxx_volume =
